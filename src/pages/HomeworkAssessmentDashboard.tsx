...
const HomeworkAssessmentDashboard: React.FC = () => {
  ...
  const getActionRecommendation = (category: string) => {
    const recommendations: Record<string, string> = {
      Iluminación:
        "Asegurar luz natural o lámparas de escritorio adecuadas. Evitar reflejos.",
      Ventilación:
        "Mantener flujo de aire constante o ventilación mecánica si es necesario.",
      "Mesa de Trabajo": "Asegurar altura adecuada y espacio para las piernas.",
      "Silla Ergonómica":
        "Proveer silla con soporte lumbar y ajuste de altura.",
      "Posición Pantalla": "Ajustar el borde superior a la altura de los ojos.",
      "Teclado y Ratón":
        "Uso de apoyamuñecas y espacio suficiente para los antebrazos.",
      "Espacio Disponible":
        "Reorganizar el mobiliario para evitar hacinamiento.",
      "Estado del Piso":
        "Retirar cables sueltos o alfombras que causen tropiezos.",
      "Ruido Ambiental":
        "Uso de auriculares con cancelación o aislamiento acústico.",
      Conectividad: "Mejorar ancho de banda o ubicación del router.",
      "Seguridad Equipos":
        "Inspección de cables eléctricos y tomas de corriente.",
      Confidencialidad:
        "Capacitación en manejo de información y bloqueo de pantalla.",
      "Pausas Activas": "Implementar alarmas o rutinas guiadas cada 2 horas.",
      "Riesgo Psicosocial":
        "Programar sesiones de seguimiento con bienestar o psicología.",
    };
    return (
    ...
    <Box p={3}>
      ...
      >
        <Box display="flex" alignItems="center" gap={2}>
          <Button
            startIcon={<BackIcon />}
            onClick={() => navigate("/admin/homework-assessments")}
          >
            Volver
          </Button>
      ...
      {stats.completed > 0 ? (
          ...
          <Grid size={{ xs: 12, lg: 4 }}>
            <Paper sx={{ p: 3, height: "500px", overflow: "auto" }}>
              ...
              <Typography variant="body2" color="textSecondary" paragraph>
                Las siguientes categorías presentan los niveles más bajos de
                cumplimiento:
              </Typography>
              <Box display="flex" flexDirection="column" gap={2}>
                {stats.top_issues.map((issue, index) => (
                  <Card
                    key={index}
                    variant="outlined"
                    sx={{ borderLeft: 6, borderLeftColor: "#f44336" }}
                  >
                    <CardContent
              ...
              <TableContainer>
                <Table size="small">
                  <TableHead sx={{ bgcolor: "grey.100" }}>
                    <TableRow>
                      <TableCell>
                        <strong>Categoría Crítica</strong>
                      </TableCell>
                      <TableCell align="center">
                        <strong>Cumplimiento</strong>
                      </TableCell>
                      <TableCell>
                        <strong>Acción de Mejora Sugerida</strong>
                      </TableCell>
                      <TableCell>
        ...
        <Alert severity="info" icon={<InfoIcon />}>
          ...
          Los datos aparecerán tan pronto los trabajadores completen sus
          autoevaluaciones con estatus "COMPLETED".
        </Alert>
      )}
    </Box>
  );
